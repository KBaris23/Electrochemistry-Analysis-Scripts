...
def detect_autotitration_vlines(
    ...
    for log_path in logs:
        ...
        try:
            ...
            try:
                log_text = raw_log.decode("utf-8-sig")
            except UnicodeDecodeError:
                # Legacy Windows queue logs may use the active ANSI code page;
                # cp1252 preserves the micro sign used in concentration labels.
